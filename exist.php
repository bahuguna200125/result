...
?>
<?php
 $sql ="SELECT user_details.user_id ,user_details.first_name, user_details.last_name
 FROM  user_details
 WHERE EXISTS (SELECT user_result.hindi FROM user_result WHERE user_details.user_id=user_result.user_id AND hindi<50)";
